...
- 最终 Compose 中声明的模型路径是 `/data/models/DeepSeek-V4-Flash-AWQ:/model`。原讨论稿中的 `/data/models/DeepSeek-V3-AWQ` 不是当前定版配置。
...
- `/data/models/DeepSeek-V4-Flash-AWQ` 指向真实存在且能在 4 卡 TP 下加载的 AWQ 模型权重。
